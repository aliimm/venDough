...
const UserTransactions = () => {
    ...
    const filteredValues = Object?.values(transactionsO)?.filter(trans => trans?.recipient_id === sessionuserId || trans?.sender_id === sessionuserId)
        ...
        <div className='transaction-container'>
            ...
            <div className='all-transactions-div'>
                <div className='page-switch-all-trans'>
                    ...
                    <div className='div-right-button-top'><NavLink className='all-trans-button-top-right' to='/home'><i class="fa-solid fa-people-arrows"></i></NavLink></div>

                    <div className='div-left-button-top'><NavLink className='all-trans-button-top-left' to='/user-transactions'><i class="fa-solid fa-user fa-lg"></i></NavLink></div>
